	...
	public Ticket createTicket(double amount, String reason, String email) {
		...
		try (Connection conn = ConnectionUtil.getConnection()) {
			...
			if(rs.next()) {
				...
				log.info("***New ticket has been created for " + empEmail + " with an id of " + id + "***");
			}else {
				
				ticket = new Ticket("Failed to create ticket");
				log.error("***Failed to create ticket for " + email + "***");
			}
	...
	public Ticket approveDeny(int id, String email, boolean approve) {
		...
		try (Connection conn = ConnectionUtil.getConnection()) {
			...
			if(rs.next()) {
				...
				log.info("***Ticket has been updated for " + empEmail + " to '" + status + "' by " + managerEmail + "***");
			}else {
				
				ticket = new Ticket("Failed to update ticket");
				log.error("***Failed to update ticket for " + email + "***");
			}
